...
*/
var colorEq = 'rgba(100,100,100,0.5)';
var colorGrid = 'rgba(105, 105, 105, 0.8)';
...
function VirtualSky(input){
	...
	this.colours = {
		'normal' : {
			...
			'constellation':colorGrid,
			'constellationboundary':"rgba(100,100,150,0.9)",
			'showers':"rgba(100,255,100,0.8)",
			'galaxy':"rgba(100,100,100,0.25)",
			'az':"rgba(100,100,255,0.3)",
			'eq':colorEq,
			'ec': colorEq,
